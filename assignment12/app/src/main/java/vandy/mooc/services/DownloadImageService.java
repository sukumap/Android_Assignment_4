...
public class DownloadImageService extends IntentService {
    ...
    public static Intent makeIntent(Context context,
        ...
        serviceIntent = new Intent(context, DownloadImageService.class);
        serviceIntent.setData(url);
        serviceIntent.putExtra(REQUEST_CODE, requestCode);
        serviceMessenger = new Messenger(downloadHandler);
        serviceIntent.putExtra(MESSENGER,serviceMessenger);
        serviceIntent.putExtra(IMAGE_PATHNAME,directoryPathname);
        Log.i("Praveen", "Directory path name is " +directoryPathname);
    ...
    public void onHandleIntent(Intent intent) {
        ...
        // @@ TODO -- you fill in here.
        String intentDirectoryPath = getImagePathname(intentExtras);

        Log.i(TAG,"Uri and Path is " +intentUri + intentDirectoryPath);
        // Download the requested image.
        // @@ TODO -- you fill in here.
        ImagePath = Utils.downloadImage(getApplicationContext(),intentUri,intentDirectoryPath);

        // Extract the Messenger stored as an extra in the
        // intent under the key MESSENGER.
        // @@ TODO -- you fill in here.
        Messenger intentMessenger = intentExtras.getParcelable(MESSENGER);
        // Send the path to the image file back to the
        // MainActivity via the messenger.
       // String downloadImagePath = ImagePath.toString();
       // Message imageMessage = Message.obtain();
        //Bundle returnData = new Bundle();
        //returnData.putString();


        //intentMessenger.send();
        // @@ TODO -- you fill in here.
        sendPath(intentMessenger, ImagePath, intentUri);
    }
    ...
    private void sendPath(Messenger messenger, 
        ...
        // Message.
        // @@ TODO -- you fill in here.
            Message sendMessagetoActivity =  makeReplyMessage(pathToImageFile,url);
            // Send the path to the image file back to the
            // MainActivity.
            // @@ TODO -- you fill in here.
        try
        {
            messenger.send(sendMessagetoActivity);
        }
    ...
    private Message makeReplyMessage(Uri pathToImageFile,
        ...
        // IMAGE_URL key.
        returnData.putString(IMAGE_URL, url.toString());
        // @@ TODO -- you fill in here.
        ...
        if (message.arg1 == Activity.RESULT_OK)
            returnData.putString(IMAGE_PATHNAME, pathToImageFile.toString());
